    ...
    >
      <div className="container mx-auto px-6">
        <h2 className="text-3xl font-bold text-center mb-4">
          My
          <span className="text-3xl text-purple"> Skills</span>
        </h2>
        <p className="text-gray-400 text-center max-w-5xl mx-auto mb-16">
          Technologies I Work With To Bring Ideas To Real Life Web Experiences.
        </p>
